...
$args = array(
	...
	'menu_title'                => esc_html__( '主题设置', 'your-textdomain-here' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( '主题设置', 'your-textdomain-here' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( '全部字段', 'guowen' ),
		'id'               => 'basic',
		'desc'             => esc_html__( '主题全部字段', 'guowen' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-home',
		'fields' => array(
			array(
				'title' => esc_html__('文章默认背景图','guowen'),
				'id' => 'p_default_bg',
				'type' => 'media',
				'url' => true
			...
			array(
				'title' => esc_html__('主题版权验证','guowen'),
				'id' => 'post_copyright_auth',
				'type' => 'switch'

			),
			array(
				'title' => esc_html__('主题版权','guowen'),
				'id' => 'post_copyright',
				'type' => 'text',
			),
			array(
				'title' => esc_html__('404 页面票据背景','guowen'),
				'id' => '404_ticket_bg',
				'type' => 'media',
			),
			array(
				'title' => esc_html__('备案信息','guowen'),
				'id' => 'gw_beian',
				'type' => 'text',
			),
	...
	array(
		...
		'sections'   => array(
			array(
				...
				'fields' => array(
					array(
						'title' => esc_html__('Bacoground Image'),
						'subtitle' => esc_html__('Background image for post'),
						'id' => 'background_img',
						'type' => 'media',
						'url' => true,
						'compiler' => true,
