 ...
 * 下载最新版本的redux . shixian post format
 */ 
...
$args = array(
  ...
  'menu_title'                => esc_html__( 'Theme Options', 'haqiye' ),
...
if ( ! isset( $args['global_variable'] ) || false !== $args['global_variable'] ) {
  ...
  $args['intro_text'] = '<p>' . sprintf( esc_html__( 'Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable: $%1$s', 'haqiye' ), '<strong>' . $v . '</strong>' ) . '<p>';
} else {
...
$args['footer_text'] = '<p>' . esc_html__( 'This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.', 'haqiye' ) . '</p>';
...
Redux_Metaboxes::set_box($opt_name,array(
  ...
  'sections'  => array(
    ...
    array(
      'title'  => __('Basic Fields','haqiye'),
      'id'  => 'app-basic-fields', 
      'desc'  => __('App Basic Fields','haqiye'), 
      'fields'  => array(
        array(
          'title'  => '应用介绍',
          'id'  => 'itemintro',
