...
add_action( 'widgets_init', 'register_hotapp_widget' );
function register_hotapp_widget() {
  register_widget( 'Hotapp_Widget' );
}

/**
 * Adds Recent Posts widget.
 */
class Hotapp_Widget extends WP_Widget {
  /**
   * Register widget with WordPress.
   */
  public function __construct() {
    parent::__construct(
      'hotapp_widget', // Base ID
      'Haapp hotapp widget', // Name
      array( 'description' => __( 'Hot app Widget', 'haapp' ) ) // Args
    );
  }
  /**
