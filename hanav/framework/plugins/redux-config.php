...
$args = array(
	...
	'menu_title'                => esc_html__( '主题设置', 'hanav' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( '主题设置', 'hanav' ),
...
$args['admin_bar_links'][] = array(
	'id'    => 'redux-docs',
	'href'  => '//webtown.cn',
	'title' => __( '文档', 'your-textdomain-here' ),
);
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Basic Fields', 'hanav' ),
		'id'               => 'basic',
		'desc'             => esc_html__( 'These are really basic fields!', 'hanav' ),
...
Redux::set_section($opt_name,array(
	'title' => esc_html__('广告区域', 'hanav'),
	'id' => 'ads',
	'desc' => esc_html__('主题广告区域', 'hanav'),
	'customizer_width' => '400px',
	'icon' => 'el el-home',
	'fields' => array(
		array(
			'title'  => esc_html__('首页顶端','hanav'),
			'subtitle' => esc_html__('图片尺寸可以自定义','hanav'),
			'id' => 'home_above',
			'type' => 'media'
		)
	)
...
Redux::set_section($opt_name,array(
	'title'  => esc_html__('尾部区域', 'hanav'),
	'id'  => 'footer_area',
	'desc'  => esc_html__('主题尾部区域', 'hanav'),
	'customizer_width'  => '400px',
	'icon'  => 'el el-home',
	'fields'  => array(
		array(
...
/**
 * Meta box 只有两个section 才会显示 tab框
 * box 可以分布在 三个位置
 * section是一个box里面的section 
 * 首先是box -> section -> fields 
 */

Redux_Metaboxes::set_box($opt_name,array(
	'id' => 'ha-metaboxes',
	'title' => esc_html__('主要字段框','hanav'),
	'post_types' => array('daohang'),
	'position' => 'normal',
	'priority' => 'high',
	'sections'  => array(
		array(
			'title' => esc_html__('导航字段', 'hanav'),
			'id'  => 'mainfields',
			'desc' => esc_html__('导航主要字段，包括网址，描述，二维码，等等', 'hanav'),
			'icon'  => 'el-icon-cogs',
			'fields'  => array(
				array(
					'title' => esc_html__('导航介绍', 'hanav'),
					'id' => 'navdesc',
					'type' => 'textarea',

				),
				array(
					'title' => esc_html__('导航链接', 'hanav'),
					'id' => 'navlink',
					'type'  => 'text',
				),
				array(
					'title' => esc_html__('导航logo', 'hanav'),
					'id' => 'navlogo',
					'type' => 'media' 
				)
		),
