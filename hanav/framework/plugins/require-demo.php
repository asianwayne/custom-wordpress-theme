...
function ocdi_import_files() {
	return array(
		array(
			'import_file_name'             => 'Hanav Demo',
			'local_import_file'            => trailingslashit( get_template_directory() ) . '/framework/plugins/demo/hanav-content.xml',
			'local_import_widget_file'     => trailingslashit( get_template_directory() ) . '/framework/plugins/demo/hanav-widgets.wie',
			'local_import_customizer_file' => trailingslashit( get_template_directory() ) . '/framework/plugins/demo/hh-customizer.dat',

			'local_import_redux'           => array(
				array(
					'file_path'   => trailingslashit( get_template_directory() ) . '/framework/plugins/demo/hanav-redux.json',
