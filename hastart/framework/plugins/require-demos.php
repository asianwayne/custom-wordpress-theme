...
function ocdi_import_files() {
	return array(
		array(
			...
			'local_import_file'            => trailingslashit( get_template_directory() ) . '/framework/plugins/demos/wordpress.xml',
			'local_import_widget_file'     => trailingslashit( get_template_directory() ) . '/framework/plugins/demos/widgets.wie',
			

			'local_import_redux'           => array(
				array(
					'file_path'   => trailingslashit( get_template_directory() ) . '/framework/plugins/demos/redux.json',
