...
//register plugins 
add_filter( 'ocdi/register_plugins', 'honghua_register_plugins' );

function honghua_register_plugins( $plugins ) {
  $theme_plugins = [
...
function ocdi_import_files() {
	return array(
		array(
			'import_file_name'             => 'Honghua Demo',
			'local_import_file'            => trailingslashit( get_template_directory() ) . '/framework/plugins/demo/hh-content.xml',
			'local_import_widget_file'     => trailingslashit( get_template_directory() ) . '/framework/plugins/demo/hh-content-widgets.wie',
			'local_import_customizer_file' => trailingslashit( get_template_directory() ) . '/framework/plugins/demo/hh-content-customizer.dat',

			'local_import_redux'           => array(
				array(
					'file_path'   => trailingslashit( get_template_directory() ) . '/framework/plugins/demo/hh-content-redux.json',
