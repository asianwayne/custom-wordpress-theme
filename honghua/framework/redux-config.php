...
$opt_name = 'theme_fields';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
Redux::set_section(
	...
	array(
		...
		'fields'  => array(
			array(
				'title' => esc_html__('Theme logo', 'honghua'),
				'id' => 'theme_logo',
				'type' => 'media'
			),
			array(
				'title' => esc_html__('扫描二维码购买', 'honghua'),
				'id' => 'gmewm',
				'type' => 'media'
			),
			array(
				'title' => esc_html__('版权信息','honghua'),
				'id' => 'hh_copyright',
				'type' => 'text'
			),
			array(
				'title' => esc_html__('联系QQ','honghua'),
				'id' => 'hh_qq',
				'type' => 'text'
			),
			array(
				'title' => esc_html__('联系微信','honghua'),
				'id' => 'hh_weixin',
				'type' => 'text'
			),
			array(
				'title' => esc_html__('备案信息','honghua'),
				'id' => 'hh_beian',
				'type' => 'text'
			),
			array(
				'title' => esc_html__('联系手机','honghua'),
				'id' => 'hh_phone',
				'type' => 'text'
			),
...
Redux::set_section($opt_name,array(
	'title' => esc_html__('分类设置', 'honghua'),
	'id' => 'hh_h_category',
	'desc' => esc_html__('Homepage category setting', 'honghua'),
	'customizer_width' => '400px',
	'fields' => array(
		array(
			'title' => esc_html__('首页分类一','honghua'),
			'subtitle' => esc_html__('点击右侧进行分类选择，只选择顶级分类也就是parent设置为了0','honghua'),
			'description' => esc_html__('这里分类只选出了顶级分类，也就是设置了参数parent为0','honghua'),
			'id' => 'h_cat_one',
			'type' => 'select',
			'data' => 'category',
			'args' => array(
			...
			array(
			'title' => esc_html__('首页分类二','honghua'),
			'subtitle' => esc_html__('点击右侧进行分类选择，只选择顶级分类也就是parent设置为了0','honghua'),
			'description' => esc_html__('这里分类只选出了顶级分类，也就是设置了参数parent为0','honghua'),
			'id' => 'h_cat_two',
			'type' => 'select',
			...
			array(
			'title' => esc_html__('首页分类三','honghua'),
			'subtitle' => esc_html__('点击右侧进行分类选择，只选择顶级分类也就是parent设置为了0','honghua'),
			'description' => esc_html__('这里分类只选出了顶级分类，也就是设置了参数parent为0','honghua'),
			'id' => 'h_cat_three',
			'type' => 'select',
			...
			array(
			'title' => esc_html__('首页分类四','honghua'),
			'subtitle' => esc_html__('点击右侧进行分类选择，只选择顶级分类也就是parent设置为了0','honghua'),
			'description' => esc_html__('这里分类只选出了顶级分类，也就是设置了参数parent为0','honghua'),
			'id' => 'h_cat_four',
			'type' => 'select',
