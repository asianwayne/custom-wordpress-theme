<?php 
add_action( 'widgets_init', 'hh_register_popular_widgets' );
function hh_register_popular_widgets() {
	register_widget( 'hh_popular_posts' );
}

/**
 * Adds Popular 小工具  按照 tie_views数值进行排列 
 */
class Hh_Popular_Posts extends WP_Widget {
	/**
	 * Register widget with WordPress.
	 */
	public function __construct() {
		parent::__construct(
			'hh_popular_posts', // Base ID
			'HH Popular Posts Widgets', // Name
			array( 'description' => __( 'Popular Posts Widget', 'honghua' ) ) // Args
		);
	}
	/**
