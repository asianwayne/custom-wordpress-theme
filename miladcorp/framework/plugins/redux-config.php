...
Redux::set_section(
	...
	array(
		...
		'fields'  => array(
			array(
				'title' => esc_html__('Theme logo light', 'honghua'),
				'id' => 'theme_logo',
				'type' => 'media'
			),

			array(
				'title' => esc_html__('Logo dark', 'honghua'),
				'id' => 'logo_dark',
				'type' => 'media'
			),
			array(
			...
			array(
				'title'  => __( 'Contact', 'nsdy' ),
				'id'  => 'ns-contact',
				'type'  => 'text',
				'data'  => array(
					'phone' => __( 'Phone', 'nsdy' ),
					'address' => __( 'Address', 'nsdy' ),
					'email'  => __( 'Email', 'nsdy' ),
					'qq'  => __( 'QQ','nsdy' ),
					'github'  => __( 'Github', 'nsdy' )
...
Redux::set_section($opt_name,array(
	'title'  => 'frontpage',
	'id'               => 'frontpage',
		'desc'             => esc_html__( 'qianduanziduan', 'your-textdomain-here' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-eye-open',
		'fields'  => $fields
...
Redux_Metaboxes::set_box($opt_name,array(
	...
	'sections'  => array(
		array(
			'id'  => 'mc-page-basic', 
			'title'  => 'Page basic fields',
			'desc'  => 'Basic fields for pages of mc theme',
			'fields'  => array(
				...
				array(
					'id'  => 'page_eng_subtitle',
					'type'  => 'text',
					'title'  => 'Page English Subtitle'


				),
				array(
					'id'  => 'mc-page-description',
					'type'  => 'editor',
