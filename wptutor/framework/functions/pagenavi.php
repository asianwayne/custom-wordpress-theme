...
function tie_get_pagenavi($query = false, $num = false , $before = '', $after = '') {
  ...
  if (!is_single()) {
    ...
    if($max_page > 1 || intval($pagenavi_options['always_show']) == 1) {
      ...
      echo $before.'<div class="pagination-list"><ul class="list-inline">'."\n";
          
          // if ($start_page >= 2 && $pages_to_show < $max_page) {
          //   // 第一页

          //   $first_page_text = str_replace("%TOTAL_PAGES%", number_format_i18n($max_page), $pagenavi_options['first_text']);
          //   echo '<li class="first"><a href="'.esc_url(get_pagenum_link()).'" class="first" title="'.$first_page_text.'">'.$first_page_text.'</a></li>';

          //   // dotleft_text
          //   if(!empty($pagenavi_options['dotleft_text'])) {
          //     echo '<li class="extend">'.$pagenavi_options['dotleft_text'].'</li>';
          //   }
          ...
          if($larger_page_to_show > 0 && $larger_start_page_start > 0 && $larger_start_page_end <= $max_page) {
            ...
            for($i = $larger_start_page_start; $i < $larger_start_page_end; $i+=$larger_page_multiple) {
              ...
              echo '<li class="numbershow"><a href="'.esc_url(get_pagenum_link($i)).'" class="page page-item page-link st" title="'.$page_text.'">'.$page_text.'</a></li>';
      ...
      if (!empty(get_next_posts_link())):
        ...
        echo '</li>';
          ...
          //     echo '<li class="extend">'.$pagenavi_options['dotright_text'].'</li>';
          //   }
