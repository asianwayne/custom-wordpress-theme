...
$section = array(
  'title'      => esc_html__( 'General Settings', 'your-textdomain-here' ),
  ...
  'fields'     => array(
    ...
    array(
      'id'  => 'disable_thumb',
      'type'  => 'switch',
      'title'  => 'Disable post thumbnail'
    ),
    array(
      'id'  => 'theme_logo_dark',
      'type'  => 'media',
      'title' => 'Theme Logo Dark'
...
$section = array(
  'title'      => esc_html__( 'Ads Banner', 'your-textdomain-here' ),
  ...
  'id'         => 'opt-banner-subsection',
  'subsection' => true,
  'fields'     => array(
    array(
      'id'       => 'wpt-banner-one',
      'type'     => 'media',
      'title'    => esc_html__( 'Home Banner One', 'your-textdomain-here' ),
      'subtitle'  => 'wpt-banner-one'
      
    ),
    array(
      'id'       => 'single_bottom_ads',
      'type'     => 'media',
      'title'    => esc_html__( 'Single bottom page', 'your-textdomain-here' ),
      'subtitle'  => 'Single bpttom ads'
