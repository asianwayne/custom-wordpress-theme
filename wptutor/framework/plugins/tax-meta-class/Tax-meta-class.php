...
class Tax_Meta_Class {
  ...
  public function __construct ( $meta_box ) {
    ...
    if (isset($meta_box['use_with_theme'])){
      if ($meta_box['use_with_theme'] === true){
        $this->SelfPath = get_template_directory_uri() . '/inc/vendor/Tax-meta-class';
    ...
    add_action( 'admin_enqueue_scripts', array( $this, 'load_scripts_styles' ),199,1 );
  ...
  public function load_scripts_styles() {
    ...
    if (in_array($taxnow,$this->_meta_box['pages'])){
      ...
      wp_enqueue_style( 'tax-meta-clss', get_template_directory_uri() . '/framework/plugins/tax-meta-class/css/Tax-meta-class.css' );
      // Enqueue Meta Box Scripts
      wp_enqueue_script( 'tax-meta-clss', get_template_directory_uri()  . '/framework/plugins/tax-meta-class/js/tax-meta-clss.js', array( 'jquery' ), null, true );
    }
